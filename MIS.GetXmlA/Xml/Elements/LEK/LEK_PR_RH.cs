...
public class LEK_PR_RH
{
    private LEkPr _lekpr;
    private LekPr2 _lekpr2;

    public LEK_PR_RH(LEkPr lekpr)
    {
        _lekpr = lekpr;
    }

    public LEK_PR_RH(LekPr2 lekpr2)
    {
        _lekpr2 = lekpr2;
    }
    ...
    public XElement Get()
    {
        ...
        ? new RepositoryMIS(new MisContext()).GetAllINJByLekPrIdAsync(_lekpr.Id).Result
