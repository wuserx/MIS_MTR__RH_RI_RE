...
public class ZakSluch
{
    public int Id { get; set; }
    public int? Pid { get; set; }
    public string? qENP { get; set; }
    ...
    private ICollection<SankZ>? sankzs;
    public virtual ICollection<SankZ>? SankZs
    {
        get { return sankzs ?? (sankzs = new Collection<SankZ>()); }
        set { sankzs = value; }
    }
